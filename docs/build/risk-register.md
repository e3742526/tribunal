...
| R-005 | Optional extractor/provider behavior drifts | medium/major | doctor, caps, golden tests, typed unavailable result | mitigated; vendor endpoints remain external |
