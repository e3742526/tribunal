...
func TestRootContainsOnlyTribunalCommands(t *testing.T) {
	root := NewRootCommand()
	allowed := "adopt arbitrate bench decisions doctor edit explain findings models panel persona recommend replay resume revert review status transcript tui verify-install version"
	var names []string
